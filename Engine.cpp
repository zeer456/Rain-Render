...
Engine::Engine(int w, int h)
{
	...
	m_planeShader->initFromFiles("shaders/spotlightObjectvert.glsl", "shaders/spotlightObjectfrag.glsl");
	...
	m_streetLampShader->initFromFiles("shaders/spotlightObjectvert.glsl", "shaders/spotlightObjectfrag.glsl");
	...
	m_particleShader->initFromFiles("shaders/Particle_spotlightvert.glsl", "shaders/Particlefrag.glsl");
	...
	spotLightColor = glm::vec3(0.0, 0.0, 1.0);

	spotExponent = 10.0f;
	spotInnerCutoff = 15.0f;
	spotOuterCutoff = 45.0f;

	spotLightAmbient = glm::vec3(0.2f, 0.2f, 0.7f);
	spotLightDiffuse = glm::vec3(0.2f, 0.2f, 0.7f);
	spotLightSpecular = glm::vec3(0.2f, 0.2f, 0.5f);
...
void Engine::drawPlane(ShaderProgram* shader, glm::mat4& modelview, glm::mat3& normalMatrix, glm::mat4& mvp)
{
...
void Engine::drawPlane(ShaderProgram* shader, glm::mat4& view, glm::mat4& projection, glm::vec3 eye)
{
	glm::mat4 model{ 1.0f };
...
void Engine::drawStreetLamp(ShaderProgram* shader, glm::mat4& view, glm::mat4& projection, glm::vec3 eye)
{
	glm::mat4 model{ 1.0f };
